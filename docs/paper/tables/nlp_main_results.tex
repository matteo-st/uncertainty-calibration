...
\midrule
SST-2 & ELECTRA & .807{\scriptsize$\pm$.014} & .346{\scriptsize$\pm$.046} & .785{\scriptsize$\pm$.016} & .069{\scriptsize$\pm$.027} & \textbf{.854{\scriptsize$\pm$.004}} & .824{\scriptsize$\pm$.018} & .072{\scriptsize$\pm$.028} \\
 & BERT & .821{\scriptsize$\pm$.024} & .378{\scriptsize$\pm$.010} & .798{\scriptsize$\pm$.017} & .113{\scriptsize$\pm$.026} & \textbf{.838{\scriptsize$\pm$.008}} & .811{\scriptsize$\pm$.018} & .087{\scriptsize$\pm$.044} \\
 & DeBERTa & .846{\scriptsize$\pm$.016} & .308{\scriptsize$\pm$.015} & .840{\scriptsize$\pm$.008} & .055{\scriptsize$\pm$.034} & \textbf{.859{\scriptsize$\pm$.008}} & .838{\scriptsize$\pm$.004} & .082{\scriptsize$\pm$.051} \\
\midrule
