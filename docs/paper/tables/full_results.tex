...
\begin{table*}[t]
\centering
\caption{Full results for all uncertainty scores before and after uniform-mass (UM) calibration. SP, PE, and Doctor are equivalent up to monotone transforms for binary tasks ($K=2$), confirmed by near-identical ROCAUC values across MRPC, SST-2, and CoLA. Results are mean $\pm$ std over 3 seeds.}
...
\midrule
SST-2 & ELECTRA & SP & .787{\scriptsize$\pm$.023} & .753{\scriptsize$\pm$.017} & .024{\scriptsize$\pm$.004} & .121{\scriptsize$\pm$.041} \\
 &  & PE & .787{\scriptsize$\pm$.023} & .753{\scriptsize$\pm$.017} & .024{\scriptsize$\pm$.004} & .110{\scriptsize$\pm$.049} \\
 &  & Doctor & .787{\scriptsize$\pm$.023} & .753{\scriptsize$\pm$.017} & .024{\scriptsize$\pm$.004} & .121{\scriptsize$\pm$.041} \\
 &  & Energy & .766{\scriptsize$\pm$.018} & .759{\scriptsize$\pm$.026} & .025{\scriptsize$\pm$.005} & .148{\scriptsize$\pm$.020} \\
 &  & MD & .857{\scriptsize$\pm$.014} & .816{\scriptsize$\pm$.024} & .024{\scriptsize$\pm$.004} & .142{\scriptsize$\pm$.049} \\
\cmidrule(l){2-7}
 & BERT & SP & .824{\scriptsize$\pm$.017} & .799{\scriptsize$\pm$.022} & .034{\scriptsize$\pm$.007} & .140{\scriptsize$\pm$.056} \\
 &  & PE & .824{\scriptsize$\pm$.017} & .799{\scriptsize$\pm$.021} & .035{\scriptsize$\pm$.009} & .140{\scriptsize$\pm$.056} \\
 &  & Doctor & .824{\scriptsize$\pm$.017} & .799{\scriptsize$\pm$.022} & .034{\scriptsize$\pm$.007} & .140{\scriptsize$\pm$.056} \\
 &  & Energy & .805{\scriptsize$\pm$.022} & .796{\scriptsize$\pm$.006} & .032{\scriptsize$\pm$.005} & .108{\scriptsize$\pm$.023} \\
 &  & MD & .848{\scriptsize$\pm$.011} & .828{\scriptsize$\pm$.002} & .033{\scriptsize$\pm$.002} & .142{\scriptsize$\pm$.031} \\
\cmidrule(l){2-7}
 & DeBERTa & SP & .821{\scriptsize$\pm$.017} & .791{\scriptsize$\pm$.035} & .023{\scriptsize$\pm$.004} & .134{\scriptsize$\pm$.070} \\
 &  & PE & .821{\scriptsize$\pm$.017} & .791{\scriptsize$\pm$.035} & .023{\scriptsize$\pm$.003} & .134{\scriptsize$\pm$.070} \\
 &  & Doctor & .821{\scriptsize$\pm$.017} & .791{\scriptsize$\pm$.035} & .023{\scriptsize$\pm$.004} & .134{\scriptsize$\pm$.070} \\
 &  & Energy & .815{\scriptsize$\pm$.028} & .795{\scriptsize$\pm$.024} & .023{\scriptsize$\pm$.001} & .138{\scriptsize$\pm$.051} \\
 &  & MD & .854{\scriptsize$\pm$.011} & .835{\scriptsize$\pm$.018} & .018{\scriptsize$\pm$.006} & .090{\scriptsize$\pm$.064} \\
\midrule
